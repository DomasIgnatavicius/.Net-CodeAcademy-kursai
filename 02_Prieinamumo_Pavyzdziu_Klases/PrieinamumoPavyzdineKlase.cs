...
namespace _02_Prieinamumo_Pavyzdziu_Klases
{
    ...
    public class PrieinamumoPavyzdineKlase // internal veikia tik projekte, todel 02 Konstuktoriai negales pasiekti
    {
        protected PrieinamumoPavyzdineKlase()
        {
            
        }
        public PrieinamumoPavyzdineKlase(string pavarde)
        {
